        ...
        while (update_count) {
                ...
                if (end_loop_flag == 1 && new_game_flag == 1) {
                    ...
                    if (player[c1].x >> 16 <= 165 + c1 * 2 || player[c1].x >> 16 >= 208 + c1 * 2) {
                        ...
                        if (player[c1].y >> 16 > 138 + c1 * 2) {
                            ...
                            if (!player[c1].action_up) player[c1].jump_ready = 1;
                        }
                    }
                    ...
                    if (player[c1].action_left && player[c1].action_right) {
                        ...
                        if (
                            (player[c1].x >> 16 <= 165 + c1 * 2 || player[c1].x >> 16 >= 208 + c1 * 2) &&
                            player[c1].y >> 16 >= 160 + c1 * 2
                        ) {
                            if (player[c1].x_add < 0) {
                                player[c1].x_add += 16384;
                        ...
                        if (
                            player[c1].x >> 16 > 165 + c1 * 2 &&
                            player[c1].x >> 16 < 208 + c1 * 2 &&
                            player[c1].y >> 16 >= 138 + c1 * 2
                        ) {
                            if (player[c1].x_add < 0) {
                                player[c1].x_add += 16384;
                                if (player[c1].x_add > 0) player[c1].x_add = 0;
            ...
            switch (fade_dir) {
                case 0:
                    if (fade_count < 30) {
                        for (c1 = 0; c1 < 48; c1++) {
                            if (fade_pal[c1] > 0) fade_pal[c1]--;
                        }
                        fade_count++;
                    } else {
                        cur_message++;
                        if (cur_message >= NUM_MESSAGES) cur_message -= NUM_MESSAGES;
                ...
                case 1:
                    if (fade_count < 100) {
                        for (c1 = 0; c1 < 48; c1++) {
                            if (fade_pal[c1] < menu_pal[c1 + 720]) fade_pal[c1]++;
                        }
                        fade_count++;
                    } else {
                        fade_dir = 0;
